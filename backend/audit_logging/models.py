...
class ChangeLog(models.Model):
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        indexes = [
            models.Index(fields=["content_type", "object_id"], name="audit_changelog_content_idx"),
            models.Index(fields=["action"], name="audit_changelog_action_idx"),
            models.Index(fields=["created_at"], name="audit_changelog_created_idx"),
            models.Index(fields=["batch_id"], name="audit_changelog_batch_idx"),
        ]
