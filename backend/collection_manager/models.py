...
class Source(models.Model):
    ...
    organism_name = models.CharField(
        max_length=300,
        verbose_name="Название организма"
    )
...
class Strain(models.Model):
    ...
    short_code = models.CharField(
        max_length=100,
        verbose_name="Короткий код штамма"
    )
    ...
    identifier = models.CharField(
        max_length=200,
        verbose_name="Идентификатор штамма"
    )
...
class Sample(models.Model):
    ...
    def __str__(self):
        strain_info = f"{self.strain.short_code}" if self.strain else "Без штамма"
        sample_num = f" ({self.original_sample_number})" if self.original_sample_number else ""
...
class ChangeLog(models.Model):
    ...
    content_type = models.CharField(max_length=20, choices=CONTENT_TYPE_CHOICES, verbose_name="Тип объекта")
    ...
    user_info = models.CharField(max_length=255, null=True, blank=True, verbose_name="Пользователь")
    ip_address = models.GenericIPAddressField(null=True, blank=True, verbose_name="IP адрес")
    user_agent = models.TextField(null=True, blank=True, verbose_name="User Agent")
    
    # Дополнительная информация
    comment = models.TextField(null=True, blank=True, verbose_name="Комментарий")
    batch_id = models.CharField(max_length=50, null=True, blank=True, verbose_name="ID массовой операции")
    ...
    @classmethod
    def log_change(cls, content_type, object_id, action, old_values=None, new_values=None, 
                   user_info=None, ip_address=None, user_agent=None, comment=None, batch_id=None):
