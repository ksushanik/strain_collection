...
class IndexLetterSchema(BaseModel):
    ...
    letter_value: str = Field(min_length=1, max_length=10, description="Значение индексной буквы")
...
class LocationSchema(BaseModel):
    ...
    name: str = Field(min_length=1, max_length=200, description="Название местоположения")
...
class SourceSchema(BaseModel):
    ...
    organism_name: str = Field(min_length=1, max_length=200, description="Название организма")
    source_type: str = Field(min_length=1, max_length=100, description="Тип источника")
    category: str = Field(min_length=1, max_length=100, description="Категория источника")
...
class AppendixNoteSchema(BaseModel):
    ...
    text: str = Field(min_length=1, max_length=1000, description="Текст примечания")
...
class StorageSchema(BaseModel):
    ...
    def validate_cell_id(cls, v: str) -> str:
        ...
        if not re.match(pattern, v.upper()):
            raise ValueError('Ячейка должна быть в формате A1-I9 (буква A-I, цифра 1-9)')
        return v.upper()
...
class ImportSampleSchema(BaseModel):
    ...
    HasPhoto: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
    IsIdentified: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
    HasAntibioticActivity: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
    HasGenome: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
    HasBiochemistry: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
    SEQStatus: Annotated[str, Field(pattern=r'^(true|false|True|False|1|0|да|нет|)$')]
