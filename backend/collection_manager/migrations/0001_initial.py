    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "box_id",
                    models.CharField(max_length=20, verbose_name="ID бокса"),
                ),
                (
                    "cell_id",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "has_photo",
                    models.BooleanField(
                        default=False, verbose_name="Есть фото"
                    ),
                ),
                (
                    "is_identified",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="Есть антибиотическая активность",
                    ),
                ),
                (
                    "has_genome",
                    models.BooleanField(
                        default=False, verbose_name="Есть геном"
                    ),
                ),
                (
                    "has_biochemistry",
