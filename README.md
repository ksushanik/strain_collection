...
- Отслеживание местоположения в хранилище (бокс/ячейка)
- Ведение справочников источников и локаций
- Управление характеристиками (фото, геном, биохимия и т.д.)
...
├── frontend/                   # React фронтенд (планируется)
